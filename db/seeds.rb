...
teachers = Teacher.create([
    ...
    {id:3, university_id:1, faculty_id:1, name: 'Carlos', last_name:'Arias', eval_sum:0.0, eval_amount:0,state:'pending'},
    {id:4, university_id:1, faculty_id:1, name: 'Daniel', last_name:'Montero', eval_sum:0.0, eval_amount:0,state:'pending'},
    {id:5, university_id:1, faculty_id:1, name: 'Bjarne', last_name:'Stroustrup', eval_sum:0.0, eval_amount:0, state:'pending'}
                          ])
...
courses = Course.create([
                            ...
                            {id:2, university_id:2, faculty_id:2, career_id:1, name: 'Comunicacion_Tecnica', eval_sum:0.0, eval_amount:0,state: 'accepted'},
                            ...
                            {id:5, university_id:1, faculty_id:1, career_id:1, name: 'Taller_de_Programacion', eval_sum:0.0, eval_amount:0,state: 'pending'},
                            {id:6, university_id:1, faculty_id:1, career_id:1, name: 'Matematica_Discreta', eval_sum:0.0, eval_amount:0,state: 'pending'},
                            {id:7, university_id:1, faculty_id:1, career_id:1, name: 'Actividad_Cultural_I', eval_sum:0.0, eval_amount:0,state: 'pending'}
                        ])
